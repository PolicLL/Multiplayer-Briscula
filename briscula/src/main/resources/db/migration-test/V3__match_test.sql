...
('11c', '123e4567-e89b-12d3-a456-426614174007', '11', 15, false, 0);
...
('12c', '123e4567-e89b-12d3-a456-42661417400b', '12', 10, false, 2),
('12d', '123e4567-e89b-12d3-a456-426614174008', '12', 10, false, 2);

-- Match 13 (2 players)
INSERT INTO match_details (id, user_id, match_id, points, winner, group_number) VALUES
('13a', '123e4567-e89b-12d3-a456-42661417400d', '13', 75, true, 0),
('13b', '123e4567-e89b-12d3-a456-426614174005', '13', 35, false, 0);

-- Match 14 (3 players)
INSERT INTO match_details (id, user_id, match_id, points, winner, group_number) VALUES
('14a', '123e4567-e89b-12d3-a456-426614174006', '14', 65, true, 0),
('14b', '123e4567-e89b-12d3-a456-426614174002', '14', 55, false, 0),
('14c', '123e4567-e89b-12d3-a456-42661417400f', '14', 0, false, 0);
...
('15c', '123e4567-e89b-12d3-a456-426614174004', '15', 20, false, 2),
('15d', '123e4567-e89b-12d3-a456-42661417400c', '15', 20, false, 2);

-- Match 16 (2 players)
INSERT INTO match_details (id, user_id, match_id, points, winner, group_number) VALUES
('16a', '123e4567-e89b-12d3-a456-42661417400a', '16', 70, true, 0),
('16b', '123e4567-e89b-12d3-a456-426614174008', '16', 50, false, 0);

-- Match 17 (3 players)
INSERT INTO match_details (id, user_id, match_id, points, winner, group_number) VALUES
('17a', '123e4567-e89b-12d3-a456-426614174007', '17', 70, true, 0),
('17b', '123e4567-e89b-12d3-a456-426614174002', '17', 20, false, 0),
...
('18c', '123e4567-e89b-12d3-a456-42661417400f', '18', 10, false, 2),
('18d', '123e4567-e89b-12d3-a456-426614174009', '18', 20, false, 2);

-- Match 19 (2 players)
INSERT INTO match_details (id, user_id, match_id, points, winner, group_number) VALUES
('19a', '123e4567-e89b-12d3-a456-42661417400e', '19', 70, true, 0),
('19b', '123e4567-e89b-12d3-a456-426614174006', '19', 50, false, 0);
...
INSERT INTO match_details (id, user_id, match_id, points, winner, group_number) VALUES
('21a', '123e4567-e89b-12d3-a456-426614174002', '21', 40, true, 1),
('21b', '123e4567-e89b-12d3-a456-42661417400c', '21', 40, true, 1),
('21c', '123e4567-e89b-12d3-a456-426614174008', '21', 20, false, 2),
('21d', '123e4567-e89b-12d3-a456-42661417400f', '21', 20, false, 2);

-- Match 22 (2 players)
INSERT INTO match_details (id, user_id, match_id, points, winner, group_number) VALUES
('22a', '123e4567-e89b-12d3-a456-426614174007', '22', 75, true, 0),
('22b', '123e4567-e89b-12d3-a456-42661417400d', '22', 45, false, 0);

-- Match 23 (3 players)
INSERT INTO match_details (id, user_id, match_id, points, winner, group_number) VALUES
('23a', '123e4567-e89b-12d3-a456-426614174005', '23', 65, true, 0),
('23b', '123e4567-e89b-12d3-a456-426614174009', '23', 55, false, 0),
('23c', '123e4567-e89b-12d3-a456-426614174003', '23', 0, false, 0);
...
('24c', '123e4567-e89b-12d3-a456-426614174004', '24', 20, false, 2),
('24d', '123e4567-e89b-12d3-a456-42661417400e', '24', 20, false, 2);

-- Match 25 (2 players)
INSERT INTO match_details (id, user_id, match_id, points, winner, group_number) VALUES
('25a', '123e4567-e89b-12d3-a456-42661417400a', '25', 80, true, 0),
('25b', '123e4567-e89b-12d3-a456-426614174007', '25', 40, false, 0);

-- Match 26 (3 players)
INSERT INTO match_details (id, user_id, match_id, points, winner, group_number) VALUES
('26a', '123e4567-e89b-12d3-a456-42661417400d', '26', 75, true, 0),
('26b', '123e4567-e89b-12d3-a456-426614174002', '26', 20, false, 0),
...
('27c', '123e4567-e89b-12d3-a456-42661417400a', '27', 0, false, 2),
('27d', '123e4567-e89b-12d3-a456-426614174008', '27', 0, false, 2);

-- Match 28 (2 players)
INSERT INTO match_details (id, user_id, match_id, points, winner, group_number) VALUES
('28a', '123e4567-e89b-12d3-a456-42661417400c', '28', 70, true, 0),
('28b', '123e4567-e89b-12d3-a456-426614174006', '28', 50, false, 0);

-- Match 29 (3 players)
INSERT INTO match_details (id, user_id, match_id, points, winner, group_number) VALUES
('29a', '123e4567-e89b-12d3-a456-426614174007', '29', 65, true, 0),
('29b', '123e4567-e89b-12d3-a456-42661417400d', '29', 45, false, 0),
('29c', '123e4567-e89b-12d3-a456-426614174002', '29', 10, false, 0);

INSERT INTO match_details (id, user_id, match_id, points, winner, group_number) VALUES
('30a', '123e4567-e89b-12d3-a456-42661417400b', '30', 55, true, 1),
('30b', '123e4567-e89b-12d3-a456-42661417400f', '30', 55, true, 1),
('30c', '123e4567-e89b-12d3-a456-426614174009', '30', 5, false, 2),
('30d', '123e4567-e89b-12d3-a456-42661417400c', '30', 5, false, 2);
