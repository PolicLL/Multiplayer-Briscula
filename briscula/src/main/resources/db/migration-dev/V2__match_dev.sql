...
INSERT INTO match_details (id, user_id, match_id, points, number_of_wins, group_number) VALUES
('1a', '123e4567-e89b-12d3-a456-426614174003', '1', 70, 1, 0),
('1b', '123e4567-e89b-12d3-a456-426614174009', '1', 50, 0, 0);

-- Match 2 (3 players, group = 0)
INSERT INTO match_details (id, user_id, match_id, points, number_of_wins, group_number) VALUES
('2a', '123e4567-e89b-12d3-a456-426614174007', '2', 70, 1, 0),
('2b', '123e4567-e89b-12d3-a456-42661417400d', '2', 30, 0, 0),
('2c', '123e4567-e89b-12d3-a456-42661417400b', '2', 20, 0, 0);

-- Match 3 (4 players, teams)
INSERT INTO match_details (id, user_id, match_id, points, number_of_wins, group_number) VALUES
('3a', '123e4567-e89b-12d3-a456-426614174002', '3', 35, 1, 1),
...
-- Match 10 (2 players)
INSERT INTO match_details (id, user_id, match_id, points, number_of_wins, group_number) VALUES
('10a', '123e4567-e89b-12d3-a456-426614174005', '10', 70, 1, 0),
('10b', '123e4567-e89b-12d3-a456-42661417400a', '10', 50, 0, 0);

-- Match 11 (3 players)
INSERT INTO match_details (id, user_id, match_id, points, number_of_wins, group_number) VALUES
('11a', '123e4567-e89b-12d3-a456-42661417400e', '11', 60, 1, 0),
...
INSERT INTO match_details (id, user_id, match_id, points, number_of_wins, group_number) VALUES
('12a', '123e4567-e89b-12d3-a456-426614174009', '12', 50, 1, 1),
...
-- Match 13 (2 players)
INSERT INTO match_details (id, user_id, match_id, points, number_of_wins, group_number) VALUES
('13a', '123e4567-e89b-12d3-a456-42661417400d', '13', 75, 1, 0),
('13b', '123e4567-e89b-12d3-a456-426614174005', '13', 35, 0, 0);

-- Match 14 (3 players)
INSERT INTO match_details (id, user_id, match_id, points, number_of_wins, group_number) VALUES
('14a', '123e4567-e89b-12d3-a456-426614174006', '14', 65, 1, 0),
...
INSERT INTO match_details (id, user_id, match_id, points, number_of_wins, group_number) VALUES
('15a', '123e4567-e89b-12d3-a456-426614174003', '15', 40, 1, 1),
...
-- Match 16 (2 players)
INSERT INTO match_details (id, user_id, match_id, points, number_of_wins, group_number) VALUES
('16a', '123e4567-e89b-12d3-a456-42661417400a', '16', 70, 1, 0),
('16b', '123e4567-e89b-12d3-a456-426614174008', '16', 50, 0, 0);

-- Match 17 (3 players)
INSERT INTO match_details (id, user_id, match_id, points, number_of_wins, group_number) VALUES
('17a', '123e4567-e89b-12d3-a456-426614174007', '17', 70, 1, 0),
...
INSERT INTO match_details (id, user_id, match_id, points, number_of_wins, group_number) VALUES
('18a', '123e4567-e89b-12d3-a456-42661417400d', '18', 50, 1, 1),
...
-- Match 19 (2 players)
INSERT INTO match_details (id, user_id, match_id, points, number_of_wins, group_number) VALUES
('19a', '123e4567-e89b-12d3-a456-42661417400e', '19', 70, 1, 0),
('19b', '123e4567-e89b-12d3-a456-426614174006', '19', 50, 0, 0);

-- Match 20 (3 players)
INSERT INTO match_details (id, user_id, match_id, points, number_of_wins, group_number) VALUES
('20a', '123e4567-e89b-12d3-a456-42661417400a', '20', 55, 1, 0),
...
INSERT INTO match_details (id, user_id, match_id, points, number_of_wins, group_number) VALUES
('21a', '123e4567-e89b-12d3-a456-426614174002', '21', 40, 1, 1),
...
-- Match 22 (2 players)
INSERT INTO match_details (id, user_id, match_id, points, number_of_wins, group_number) VALUES
('22a', '123e4567-e89b-12d3-a456-426614174007', '22', 75, 1, 0),
('22b', '123e4567-e89b-12d3-a456-42661417400d', '22', 45, 0, 0);

-- Match 23 (3 players)
INSERT INTO match_details (id, user_id, match_id, points, number_of_wins, group_number) VALUES
('23a', '123e4567-e89b-12d3-a456-426614174005', '23', 65, 1, 0),
...
INSERT INTO match_details (id, user_id, match_id, points, number_of_wins, group_number) VALUES
('24a', '123e4567-e89b-12d3-a456-42661417400b', '24', 40, 1, 1),
...
-- Match 25 (2 players)
INSERT INTO match_details (id, user_id, match_id, points, number_of_wins, group_number) VALUES
('25a', '123e4567-e89b-12d3-a456-42661417400a', '25', 80, 1, 0),
('25b', '123e4567-e89b-12d3-a456-426614174007', '25', 40, 0, 0);

-- Match 26 (3 players)
INSERT INTO match_details (id, user_id, match_id, points, number_of_wins, group_number) VALUES
('26a', '123e4567-e89b-12d3-a456-42661417400d', '26', 75, 1, 0),
...
INSERT INTO match_details (id, user_id, match_id, points, number_of_wins, group_number) VALUES
('27a', '123e4567-e89b-12d3-a456-426614174003', '27', 60, 1, 1),
...
-- Match 28 (2 players)
INSERT INTO match_details (id, user_id, match_id, points, number_of_wins, group_number) VALUES
('28a', '123e4567-e89b-12d3-a456-42661417400c', '28', 70, 1, 0),
('28b', '123e4567-e89b-12d3-a456-426614174006', '28', 50, 0, 0);

-- Match 29 (3 players)
INSERT INTO match_details (id, user_id, match_id, points, number_of_wins, group_number) VALUES
('29a', '123e4567-e89b-12d3-a456-426614174007', '29', 65, 1, 0),
...
INSERT INTO match_details (id, user_id, match_id, points, number_of_wins, group_number) VALUES
('30a', '123e4567-e89b-12d3-a456-42661417400b', '30', 55, 1, 1),
